/* NetworkUtils.java is borrowed from the SER321 AdvancedCustomProtocol example
* https://github.com/amehlhase316/ser321examples/tree/master/Sockets/AdvancedCustomProtocol
* All credit for this code goes to David Clements
*/
  ...
  public static byte[] intToBytes(final int data) {
    ...
    */
    public static void Send(DatagramSocket sock, InetAddress addr, int port, byte... bytes) throws IOException {
      ...
      int packetsTotal = bytes.length / maxBufferLength + 1; // potential bug?
